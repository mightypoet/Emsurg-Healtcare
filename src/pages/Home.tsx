    ...
    <div className="bg-white">
      ...
      <section className="py-24 bg-white border-t border-slate-100">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-light tracking-tight text-slate-800 mb-4">
            Why Healthcare Partners Choose Emsurg
          </h2>
          <p className="text-sm text-slate-500 mb-14 max-w-xl mx-auto font-normal">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            {[
              ...
              <div 
                key={idx} 
                className="flex flex-col items-center justify-center p-6 sm:p-8 bg-slate-50/60 rounded-2xl border border-slate-100 hover:border-slate-300 transition-all text-center group"
              >
      ...
      {/* Final CTA */}
      <section className="py-28 bg-[#0F172A] text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          ...
          <p className="text-base md:text-lg text-slate-300 mb-10 font-normal max-w-xl mx-auto">
