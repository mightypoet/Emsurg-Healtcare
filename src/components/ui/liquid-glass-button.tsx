...
> = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#000] to-[#A0A0A0]",
    inner: "bg-gradient-to-b from-blue-700 via-blue-500 to-blue-200",
    button: "bg-gradient-to-b from-blue-600 to-blue-600/40",
    textColor: "text-white",
  ...
  return (
    <div className={variants.wrapper} style={variants.wrapperStyle}>
      ...
      >
        ...
        <span className="flex items-center gap-2 relative z-10">{buttonText}</span>
